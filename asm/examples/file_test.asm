...
; Every drive/user is mapped onto a single host directory (cpm_disk/,
; created next to wherever bin/z80 is run from) - see cpm.c's File I/O
; comment. Same "OK n"/"FAIL n" convention as selftest.asm/gaps_test.asm.
