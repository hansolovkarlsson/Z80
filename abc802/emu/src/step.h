// abc802/emu/src/step.h - one ABC802 instruction, with the per-instruction
// machine concerns that go with it.
//
// Shared between bin/abc802 and bin/abc802-gtk so neither has its own copy
...
#ifndef ABC802_STEP_H
#define ABC802_STEP_H
