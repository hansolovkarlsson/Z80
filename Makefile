...
# guess at names.
DEPS := $(EMU_OBJS:.o=.d) $(ASM_OBJS:.o=.d) $(DASM_OBJS:.o=.d) $(GTK_OBJS:.o=.d) $(ABC80_OBJS:.o=.d) $(ABC802_OBJS:.o=.d) $(ABC80_GTK_OBJS:.o=.d) $(ABC80_CHARGEN_DUMP_OBJS:.o=.d) $(ABC80_VIDEO_TIMING_DUMP_OBJS:.o=.d) $(ABC80_RENDER_DEMO_OBJS:.o=.d) $(ABC80_SOUND_DEMO_OBJS:.o=.d)

clean:
	rm -f $(DEPS) $(EMU_OBJS) $(ASM_OBJS) $(DASM_OBJS) $(GTK_OBJS) $(ABC80_OBJS) $(ABC80_GTK_OBJS) $(ABC80_CHARGEN_DUMP_OBJS) $(ABC80_VIDEO_TIMING_DUMP_OBJS) $(ABC80_RENDER_DEMO_OBJS) $(ABC80_SOUND_DEMO_OBJS) $(ABC802_OBJS) $(ABC802_TARGET) $(EMU_TARGET) $(ASM_TARGET) $(DASM_TARGET) $(GTK_TARGET) $(ABC80_TARGET) $(ABC80_GTK_TARGET) $(ABC80_CHARGEN_DUMP_TARGET) $(ABC80_VIDEO_TIMING_DUMP_TARGET) $(ABC80_RENDER_DEMO_TARGET) $(ABC80_SOUND_DEMO_TARGET) $(EMU_TEST_INTERRUPTS_TARGET)
