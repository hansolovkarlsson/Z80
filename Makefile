...
ABC806_OBJS := $(ABC806_SRC_DIR)/main.o $(ABC806_SRC_DIR)/memory.o $(ABC806_SRC_DIR)/ports.o $(ABC806_SRC_DIR)/step.o $(ABCBUS_OBJS) $(Z80CORE_SRC_DIR)/z80.o $(Z80CORE_SRC_DIR)/alu.o
...
.PHONY: all emulator assembler disassembler abcdisk gtk abc80 abc802 abc806 abc802-chargen-dump abc802-gtk abc80-gtk abc80-chargen-dump abc80-video-timing-dump abc80-render-demo abc80-sound-demo run test test-cpm test-abc80 test-abc802 clean
...
test: test-cpm test-abc80 test-abc802
...
# guess at names.
DEPS := $(EMU_OBJS:.o=.d) $(ASM_OBJS:.o=.d) $(DASM_OBJS:.o=.d) $(GTK_OBJS:.o=.d) $(ABC80_OBJS:.o=.d) $(ABC802_OBJS:.o=.d) $(ABCBUS_OBJS:.o=.d) $(ABCDISK_OBJS:.o=.d) $(ABC806_OBJS:.o=.d) $(ABC80_GTK_OBJS:.o=.d) $(ABC80_CHARGEN_DUMP_OBJS:.o=.d) $(ABC80_VIDEO_TIMING_DUMP_OBJS:.o=.d) $(ABC80_RENDER_DEMO_OBJS:.o=.d) $(ABC80_SOUND_DEMO_OBJS:.o=.d)

clean:
	rm -f $(DEPS) $(EMU_OBJS) $(ASM_OBJS) $(DASM_OBJS) $(GTK_OBJS) $(ABC80_OBJS) $(ABC80_GTK_OBJS) $(ABC80_CHARGEN_DUMP_OBJS) $(ABC80_VIDEO_TIMING_DUMP_OBJS) $(ABC80_RENDER_DEMO_OBJS) $(ABC80_SOUND_DEMO_OBJS) $(ABC802_OBJS) $(ABC806_OBJS) $(ABCBUS_OBJS) $(ABCDISK_OBJS) $(ABCDISK_TARGET) $(ABC806_TARGET) $(ABC802_TARGET) $(EMU_TARGET) $(ASM_TARGET) $(DASM_TARGET) $(GTK_TARGET) $(ABC80_TARGET) $(ABC80_GTK_TARGET) $(ABC80_CHARGEN_DUMP_TARGET) $(ABC80_VIDEO_TIMING_DUMP_TARGET) $(ABC80_RENDER_DEMO_TARGET) $(ABC80_SOUND_DEMO_TARGET) $(EMU_TEST_INTERRUPTS_TARGET)
