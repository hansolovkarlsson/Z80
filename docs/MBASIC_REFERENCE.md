...
A reference for Microsoft's BASIC-80 (MBASIC) — `resources/Mbasic.com`,
the other real CP/M program this emulator has been validated against (see
`docs/ROADMAP.md`'s "Real-world validation: MBASIC" milestone and
`docs/CPM_REFERENCE.md`'s BIOS section for how that testing led to a real
...
Unlike `docs/TASTYBASIC_REFERENCE.md`, this document is **not** derived
