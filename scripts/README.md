...
build recipes under `resources/*/` (e.g. `resources/sargon/derive.sh`),
...
- **`8080_to_z80.py`** — a general-purpose 8080-mnemonic → Z80-mnemonic
  ...
  `A,` operand vs. not). Built for `resources/ccp/`'s CCP source (CP/M
  ...
  header comment for the full approach, and `resources/ccp/derive.sh` for
